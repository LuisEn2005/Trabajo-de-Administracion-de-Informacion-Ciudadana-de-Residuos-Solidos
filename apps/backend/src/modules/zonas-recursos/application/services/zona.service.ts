...
import { Zona } from '../../domain/aggregates/zona';
import { MapaCalor, PuntoCalor } from '../../domain/entities/mapa-calor';
import { AsignacionRecurso } from '../../domain/entities/asignacion-recurso';
import { ReporteSemanal } from '../../domain/entities/reporte-semanal';
import { ClasificadorZonasCriticas } from '../../domain/services/clasificador-zonas-criticas';
import {
  IZonaRepositorio,
  IMapaCalorRepositorio,
  IAsignacionRepositorio,
  IReporteSemanalRepositorio,
} from '../../domain/repositories/zona.repositorio';
